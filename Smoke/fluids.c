...
//                 Although the simulation takes place on a 2D grid, we allocate all data structures
//                 as 1D arrays, for compatibility with the FFTW numerical library.
...
// diffuse_matter: This function diffuses matter that has been placed in the velocity field. It's
// almost identical to the velocity diffusion step in the function above. The input matter densities
// are in rho0 and the result is written into rho.
void diffuse_matter(
    int n, fftw_real *vx, fftw_real *vy, fftw_real *rho, fftw_real *rho0, fftw_real dt)
{
...
// drag: When the user drags with the mouse, add a force that corresponds to the direction of the
// mouse
